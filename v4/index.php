...
<head>
    ...
    <style>
        ...
        /* =========================================================
           FIX DE RENDERIZADO PARA CHROME (SIN ROMPER EL MENÚ)
           ========================================================= */
        
        /* Elevamos el contenedor para evitar sobreposiciones en clics sin usar translateZ */
        .tab-pane > .container { 
            position: relative; 
            z-index: 1; 
        }

        /* Forzamos un color gris oscuro SÓLIDO eliminando toda variable de opacidad.
           Esto previene el bug de Chrome al renderizar textos "transparentes" sobre SVG fijos. */
        .text-muted {
        ...
        .navbar {
            ...
            position: sticky;
            top: 0;
            z-index: 1050 !important; /* Capa superior absoluta para evitar bloqueos de clic */
        }
...
<body>
    ...
    <main class="tab-content" id="spaContent">
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel">
            ...
            <!-- FONDO EXCLUSIVO DE INICIO: CORREDOR LATERAL -->
            <div class="bg-watermark-lateral">
                <svg viewBox="0 0 400 1080" preserveAspectRatio="xMaxYMid slice" xmlns="http://www.w3.org/2000/svg">
                    <path class="via-agua" fill="none" stroke="var(--verde-oscuro)" d="M 300 -50 L 300 300 Q 300 350 250 400 L 150 500 Q 100 550 100 600 L 100 1150" />
                    <circle cx="300" cy="150" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-oscuro)"/>
                    <circle cx="250" cy="400" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-oscuro)"/>
                    <circle cx="100" cy="800" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-oscuro)"/>

                    <path class="via-agua" fill="none" stroke="var(--naranja)" d="M 150 -50 L 150 150 Q 150 200 200 250 L 350 400 Q 400 450 400 500 L 400 750 Q 400 800 350 850 L 200 1000" />
                    <circle cx="150" cy="150" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--naranja)"/>
                    <circle cx="350" cy="400" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--naranja)"/>
                    <circle cx="400" cy="750" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--naranja)"/>

                    <path class="via-agua" fill="none" stroke="var(--verde-claro)" d="M 50 250 L 150 350 Q 200 400 200 450 L 200 700 Q 200 750 150 800 L 50 900" />
                    <circle cx="150" cy="350" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-claro)"/>
                    <circle cx="200" cy="600" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-claro)"/>

                    <path class="via-agua" fill="none" stroke="var(--verde-medio)" d="M 450 50 L 350 150 Q 300 200 300 250 L 300 550 Q 300 600 250 650 L 0 900" />
                    <circle cx="350" cy="150" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-medio)"/>
                    <circle cx="300" cy="550" r="14" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-medio)"/>
                </svg>
            </div>
        ...
        <div class="tab-pane fade" id="porque" role="tabpanel">
            ...
            <!-- FONDO EXCLUSIVO DE ¿POR QUÉ?: RED METROPOLITANA -->
            <div class="bg-watermark-full">
                <svg viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
                    <path class="via-agua" fill="none" stroke="var(--naranja)" d="M -100 200 L 400 300 Q 500 320 600 450 L 900 850 Q 1000 980 1200 1000 L 2100 1050" />
                    <circle cx="400" cy="300" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--naranja)"/>
                    <circle cx="900" cy="850" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--naranja)"/>
                    <circle cx="1200" cy="1000" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--naranja)"/>

                    <path class="via-agua" fill="none" stroke="var(--verde-oscuro)" d="M 200 -100 L 200 400 Q 200 500 350 600 L 700 800 Q 800 850 800 1000 L 800 1200" />
                    <circle cx="200" cy="400" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-oscuro)"/>
                    <circle cx="700" cy="800" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-oscuro)"/>

                    <path class="via-agua" fill="none" stroke="var(--verde-medio)" d="M -100 800 L 300 800 Q 400 800 500 700 L 1100 100 Q 1200 0 1400 0 L 2100 0" />
                    <circle cx="300" cy="800" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-medio)"/>
                    <circle cx="1100" cy="100" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-medio)"/>

                    <path class="via-agua" fill="none" stroke="var(--verde-claro)" d="M 1600 -100 L 1600 300 Q 1600 400 1500 500 L 1100 900 Q 1000 1000 1000 1200" />
                    <circle cx="1600" cy="300" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-claro)"/>
                    <circle cx="1100" cy="900" r="12" class="nodo-agua" fill="#f8f9fa" stroke="var(--verde-claro)"/>
                </svg>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tabLinks.forEach(tab => {
                tab.addEventListener('shown.bs.tab', function (e) {
                    ...
                    // Modificación: Agregamos history.pushState para que el botón "Atrás" del navegador funcione
            ...
            // Manejador del botón "Atrás" nativo del navegador
            window.addEventListener('popstate', function() {
                let hash = window.location.hash || '#home'; // Default a #home si no hay hash
                let tabTrigger = document.querySelector('.main-nav-link[data-bs-target="' + hash + '"]');
                if (tabTrigger) {
                    let tab = new bootstrap.Tab(tabTrigger);
                    tab.show();

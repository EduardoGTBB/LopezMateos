...
?>
    ...
    <!-- ==========================================
         WIDGET DE SISTEMA FLOTANTE ÚNICO
         ========================================== -->
    <div id="sysNoticeLayer" class="sys-floating-widget d-none">
        <div class="sys-dialog position-relative">
            <!-- Botón flotante externo (Continuar sin aceptar) -->
            <button id="btn-sys-dismiss" class="btn-sys-floating shadow-sm">Continuar sin aceptar</button>
            
            <div class="sys-card shadow-lg bg-white rounded-4 overflow-hidden border border-dark-subtle">
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <h3 class="fw-black m-0" style="color: var(--verde-oscuro); font-size: 1.5rem;">Gestión de datos</h3>
                        <i class="bi bi-shield-check fs-2 text-muted opacity-50"></i>
                    </div>
                    
                    <p class="text-muted lh-sm mb-3" style="font-size: 0.85rem;">
                        En este sitio, utilizamos herramientas internas para medir nuestra audiencia y asegurarnos de que la página funcione rápido y sin errores.
                    </p>
                    <p class="text-muted lh-sm mb-3" style="font-size: 0.85rem;">
                        Puedes modificar tus preferencias en cualquier momento. Para conocer más detalles sobre cómo cuidamos tu información, puedes leer nuestro documento legal.
                    </p>
                    
                    <!-- Enlace al Modal de Privacidad -->
                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalPrivacidad" class="text-decoration-underline fw-semibold" style="color: var(--verde-medio); font-size: 0.85rem;">
                        Consultar aviso de privacidad
                    </a>
                </div>
                
                <!-- Botones inferiores -->
                <div class="d-flex border-top border-dark-subtle mt-1">
                    <button id="btn-sys-config" class="btn sys-btn-half text-muted fw-bold bg-light" data-bs-toggle="modal" data-bs-target="#modalConfiguracion">Configurar</button>
                    <button id="btn-sys-accept" class="btn sys-btn-half text-white fw-bold" style="background-color: #009EDB;">Aceptar</button>
                </div>
            </div>
        </div>
    </div>

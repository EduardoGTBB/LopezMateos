...
<body data-bs-spy="scroll" data-bs-target="#navbar-principal">
    ...
    <section class="container-fluid p-0">
        <div class="row g-0">
            ...
            <div class="col-md-6 p-4 p-lg-5" style="background-color: var(--color-oscuro); color: white;">
                ...
                <p class="mb-0">La ciudadanía decidirá sobre el Plan Integral de López Mateos. Fecha por confirmar.</p>
            </div>
        </div>
    </section>
    ...
    <section class="seccion-clara py-5 my-lg-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 order-lg-1 pe-lg-5">
                    ...
                    <div class="d-flex align-items-start mb-4">
                        ...
                        <div>
                            <h4 class="fw-bold mb-1">Velocidad en hora pico</h4>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <h4 class="fw-bold mb-1">De antigüedad del drenaje</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                        ...
                        <div class="row justify-content-center gx-4 gy-4">
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                                    <div>
                                        <h5 class="fw-bold mb-1 fs-6" style="color: var(--color-primario);">Traslados poco previsibles</h5>
                                        <p class="text-muted mb-0" style="font-size: 0.9rem;">Viajes locales, de paso, transporte público y carga comparten una misma avenida.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                                    <div>
                                        <h5 class="fw-bold mb-1 fs-6" style="color: var(--color-primario);">Transporte público atrapado</h5>
                                        <p class="text-muted mb-0" style="font-size: 0.9rem;">Los autobuses circulan entre el tráfico general y pierden velocidad y regularidad.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                                    <div>
                                        <h5 class="fw-bold mb-1 fs-6" style="color: var(--color-primario);">Dificultad para cruzar con seguridad</h5>
                                        <p class="text-muted mb-0" style="font-size: 0.9rem;">El corredor funciona como barrera entre colonias y aumenta el riesgo para peatones y ciclistas.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                                    <div>
                                        <h5 class="fw-bold mb-1 fs-6" style="color: var(--color-primario);">Inundaciones recurrentes</h5>
                                        <p class="text-muted mb-0" style="font-size: 0.9rem;">El drenaje actual no responde a la demanda ni a los episodios de lluvia.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                                    <div>
                                        <h5 class="fw-bold mb-1 fs-6" style="color: var(--color-primario);">Conectividad limitada</h5>
                                        <p class="text-muted mb-0" style="font-size: 0.9rem;">Cuando López Mateos se satura, también se complica el acceso al sur de la metrópoli.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <h4 class="fw-bold mt-5" style="color: var(--color-primario);">Estos problemas están relacionados entre sí. Por eso, atender López Mateos requiere una solución integral y no una sola intervención.</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="mb-5">El Plan no se diseñó desde un escritorio: se integraron estudios técnicos, información territorial y la experiencia de más de 64 mil personas que participaron entre 2022 y 2025.</p>
                </div>
                <div class="col-lg-12">
                    <div class="row mb-1">
                        <div class="col-4 mb-3">
                            <div class="caja-dato">
                                <span class="fw-bold fs-5 d-block">2022</span>
                                <span class="small">Radiografía del área</span>
                                <p>Información territorial · IIEG</p>
                            </div>
                        </div>
                        <div class="col-4 mb-3">
                            <div class="caja-dato">
                                <span class="fw-bold fs-5 d-block">2022–23</span>
                                <span class="small">Diálogos por la Movilidad</span>
                                <p>58,856 participantes</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="caja-dato">
                                <span class="fw-bold fs-5 d-block">2024</span>
                                <span class="small">PIMUS y POTMet</span>
                                <p>Estudios técnicos</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="caja-dato">
                                <span class="fw-bold fs-5 d-block">2025</span>
                                <span class="small">Mesas de Diálogo</span>
                                <p>6,083 participantes</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="caja-dato">
                                <span class="fw-bold fs-5 d-block">Estamos aquí</span>
                                <span class="small">Socialización</span>
                                <p>Módulos, sitio web y reuniones</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="caja-dato">
                                <span class="fw-bold fs-5 d-block">Después</span>
                                <span class="small">Consulta Popular</span>
                                <p>Fecha por confirmar</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center gx-4 gy-4">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            ...
                            <div>
                                <h5 class="fw-bold mb-1 fs-6 text-center">Viaducto subterráneo · <span class="text-muted">Tramo urbano · 6.28 km</span></h5>
                                <p class="text-muted mb-0 text-center" style="font-size: 0.9rem;">Mueve parte del tráfico de paso por debajo del nivel de calle para separarlo de los viajes locales y liberar la superficie para todo lo demás.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            <div class="me-2 fs-3 lh-1" style="color: var(--color-primario);">🚌</div>
                            <div>
                                <h5 class="fw-bold mb-1 fs-6">Transporte público · <span class="text-muted">Ambos tramos · 4.3 km de carril exclusivo, 7 estaciones y 1 ruta exprés</span></h5>
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Carril confinado y estaciones en el tramo urbano, ruta exprés en el suburbano, conectados con Mi Macro Periférico y las Líneas 1 y 5.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            <div class="me-2 fs-3 lh-1" style="color: var(--color-primario);">🚲</div>
                            <div>
                                <h5 class="fw-bold mb-1 fs-6">Ciclovía · <span class="text-muted">Tramo urbano · 6.01 km</span></h5>
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Carril confinado en López Mateos y Mariano Otero, conectado con la red ciclista existente.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            <div class="me-2 fs-3 lh-1" style="color: var(--color-primario);">🚶</div>
                            <div>
                                <h5 class="fw-bold mb-1 fs-6">Cruces seguros · <span class="text-muted">Tramo urbano · 9 mejorados y 4 nuevos</span></h5>
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Cruces a nivel de calle en lugar de puentes poco accesibles, con accesibilidad universal.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            <div class="me-2 fs-3 lh-1" style="color: var(--color-primario);">🌳</div>
                            <div>
                                <h5 class="fw-bold mb-1 fs-6">Espacios públicos · <span class="text-muted">Tramo urbano · 780 m y 1.6 km</span></h5>
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Dos parques lineales, arbolado, iluminación y zonas de descanso y convivencia.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            <div class="me-2 fs-3 lh-1" style="color: var(--color-primario);">💧</div>
                            <div>
                                <h5 class="fw-bold mb-1 fs-6">Drenaje · <span class="text-muted">Tramo urbano · 4.6 km de colectores</span></h5>
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Colectores separados para agua residual y de lluvia, con 20% más capacidad.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="d-flex align-items-start border-bottom border-dark-subtle pb-3 h-100">
                            <div class="me-2 fs-3 lh-1" style="color: var(--color-primario);">🌉</div>
                            <div>
                                <h5 class="fw-bold mb-1 fs-6">Viaducto elevado · <span class="text-muted">Tramo suburbano · 11.84 km</span></h5>
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Separa los viajes largos y el transporte de carga del tránsito local, manteniendo los accesos a nivel de calle.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- LÍNEA CONECTORA 4 (1 sola Línea Izquierda a Centro) -->
    <div class="conector-metro d-none d-md-flex">
        <svg viewBox="0 0 1000 220" preserveAspectRatio="none">
    ...
    <!-- LÍNEA CONECTORA 5 (3 Líneas de Centro a Derecha) -->
    <div class="conector-metro d-none d-md-flex">
        <svg viewBox="0 0 1000 220" preserveAspectRatio="none">
            <!-- Naranja -->
            <path class="linea-via" stroke="var(--naranja)" d="M 500 0 L 500 60 Q 500 80 530 80 L 820 80 Q 850 80 850 100 L 850 220" />
        ...
        <div class="container py-lg-5 text-center">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-6 col-md-3">
                    <h5 class="fw-bold" style="color: var(--verde-oscuro:);">📍 Módulos informativos</h5>
                    <p class="small">30 módulos a lo largo del corredor con materiales y atención de dudas.</p>
                </div>
                <div class="col-6 col-md-3">
                    <h5 class="fw-bold" style="color: var(--verde-oscuro:);">💻 Página web</h5>
                    <p class="small">Encontrarás componentes y mapa del Proyecto, preguntas frecuentes y documentos.</p>
                </div>
                <div class="col-6 col-md-3">
                    <h5 class="fw-bold" style="color: var(--verde-oscuro:);">🗣️ Reuniones</h5>
                    <p class="small">Espacios de diálogo con vecinos, comercios, organizaciones y grupos de interés.</p>
                </div>
                <div class="col-6 col-md-3">
                    <h5 class="fw-bold" style="color: var(--verde-oscuro:);">🏠 Visitas a viviendas y comercios</h5>
                    <p class="small">El equipo en campo comparte información y atiende dudas puntuales.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container py-lg-4 contenedor-lectura">
            ...
            <div class="accordion mb-5" id="accordionFaq">
                ...
                <div class="accordion-item">
                    ...
                    <div id="faq" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
                        <div class="accordion-body text-muted bg-white">
            ...
            <div class="text-center border-top border-dark-subtle pt-4 mt-5">
                ...
                <p>Escríbenos por WhatsApp para resolver una duda puntual, o usa el formulario de contacto del pie si quieres enviar un comentario más amplio o sumarte a una reunión.</p>
    ...
    <footer class="py-5" style="background-color: var(--color-oscuro); color: white;">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-5">
                    <h4 class="fw-bold mb-3" style="color: var(--verde-pdf2);">Plan Integral de López Mateos</h4>
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-2 small">
                        ...
                        <li><a href="#" class="text-white-50 text-decoration-none">Socialización y Consulta</a></li>
